...
def get_models(app):
    ...
    class Email(db.Model):
        ...
        text = db.Column(db.String)  # email body

        folders = db.relationship("Folder", secondary=email_folder, backref="emails")  # declares a property 'emails' on the 'Folder' class
        attachments = db.relationship("Attachment", backref="email", lazy=True)  # declares a property 'email' on the 'Attachment' class
        def __repr__(self):
